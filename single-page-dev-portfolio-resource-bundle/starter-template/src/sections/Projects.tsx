    ...
    <div className="container">
      ...
      <div className="flex flex-col mt-10 md:mt-20 gap-20">
        {portfolioProjects.map((project) => (
          <Card 
          key={project.title} 
          className=" px-8 pt-8  pb-0 md:pt-12 px-10 lg:pt-16 lg:px-20 sticky top-16 "
          >
          ...
          <Image 
          src={project.image} alt={project.title} className="mt-8 -mb-4 md:-mb-0 items-center justify-center lg:mt-0 lg:absolute lg:h-full lg:w-auto lg:max-w-none"/>
            </div>
            </div>
          </Card>
